...
//使用toast信息提示框显示信息
    ...
    SharedPreferences
*/
    public void saveLoginUserInfo(Context context, String key ,LoginUser userInfo) throws IOException {
        this.userInfo=userInfo;
    ...
    public LoginUser  getLoginUserInfo(Context context, String key) throws IOException {
       this.userInfo= (LoginUser)readObject(context,key);
        return userInfo;
    }
